 ...
 *
 *=========================================================================*/
#ifndef __itkStreamingLabelStatisticsImageFilter_h
#define __itkStreamingLabelStatisticsImageFilter_h
 ...
 * \brief Given an intensity image and a label map, compute min, max,
 * variance and mean of the pixels associated with each label or
 * segment
 *
 * StreamingLabelStatisticsImageFilter computes the minimum, maximum, sum,
...
public:
  ...
  typedef StreamingLabelStatisticsImageFilter Self;
  ...
  itkTypeMacro(StreamingLabelStatisticsImageFilter, ImageToImageFilter);
  ...
  typedef typename LabelStatisticsImageFilter<TInputImage, TLabelImage>::LabelStatistics LabelStatistics;
...
#include "itkStreamingLabelStatisticsImageFilter.hxx"
