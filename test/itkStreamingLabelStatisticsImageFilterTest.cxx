...
int itkStreamingLabelStatisticsImageFilterTest(int argc, char* argv [] )
{
  std::cout << "itkStreamingLabelStatisticsImageFilterTest Start" << std::endl;
  ...
  typedef itk::StreamingLabelStatisticsImageFilter< ImageType, ImageType > FilterType;
